...
const Schema: z.ZodType<Prisma.ItemActionUncheckedUpdateManyWithoutItemNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      updateMany: z
        .union([
          z.lazy(
            () => ItemActionUpdateManyWithWhereWithoutItemInputObjectSchema,
          ),
          z
            .lazy(
              () => ItemActionUpdateManyWithWhereWithoutItemInputObjectSchema,
...
export const ItemActionUncheckedUpdateManyWithoutItemNestedInputObjectSchema =
  Schema;
