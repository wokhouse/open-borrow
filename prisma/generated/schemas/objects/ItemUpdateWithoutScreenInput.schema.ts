...
import { ItemActionUpdateManyWithoutItemNestedInputObjectSchema } from './ItemActionUpdateManyWithoutItemNestedInput.schema';

import type { Prisma } from '@prisma/client';

const Schema: z.ZodType<Prisma.ItemUpdateWithoutScreenInput> = z
  .object({
    id: z
      .union([
        z.string(),
    ...
    type: z
      ...
      .optional(),
    actions: z
      .lazy(() => ItemActionUpdateManyWithoutItemNestedInputObjectSchema)
      .optional(),
  })
  .strict();

export const ItemUpdateWithoutScreenInputObjectSchema = Schema;
