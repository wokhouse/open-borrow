...
const Schema: z.ZodType<Prisma.ItemActionUncheckedUpdateManyWithoutActionsInput> =
  z
    .object({
      id: z
        .union([
...
export const ItemActionUncheckedUpdateManyWithoutActionsInputObjectSchema =
  Schema;
